...
mod moves_tests {
    ...
    pub fn board_same_for_fen_and_uci_position_moves() {
        let from_fen = Board::from_fen("1r1r4/p1p2pp1/3kp1bp/3n4/1b1P4/4PB2/PB1N1PPP/3RK1R1 b - - 6 23").unwrap();

        let mut uci = UciInterface::new(2);
        initialize_magic_bitboards();

        uci.process_command("position startpos moves d2d4 d7d5 g1f3 c8f5 c2c4 e7e6 d1b3 b8c6 c1d2 d5c4 b3b7 g8e7 b7b5 a8b8 b5a4 b8b2 b1a3 b2b8 a3c4 h7h6 h1g1 f5e4 d2c3 h8g8 a1d1 d8d7 f3d2 e4g6 c4a5 c6a5 a4d7 e8d7 c3a5 e7c6 a5c3 f8b4 c3a1 d7d6 e2e3 g8d8 f1e2 c6e7 a1b2 e7d5 e2f3 g6c2 d1c1 c2d3 c1d1 d3c2 d1c1");
