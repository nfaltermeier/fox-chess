...
impl Board {
    ...
    pub fn generate_pseudo_legal_captures_and_queen_promos(
        &mut self,
        history_table: &HistoryTable,
        moves: &mut ArrayVec<ScoredMove, MOVE_ARRAY_SIZE>,
    ) {
        self.generate_moves_pseudo_legal::<false, true>(history_table, moves);
        ...
        while promos != 0 {
            ...
            moves.push(ScoredMove::new(
                ...
                MOVE_SCORE_QUIET
                    ...
                    + CENTIPAWN_VALUES_MIDGAME[PIECE_QUEEN as usize],
            ));
        }
